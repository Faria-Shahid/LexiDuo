...
private:
    ...
    void displayLetters() {
        ...
        cout << "\t\t / " << "  \\ " << "   / " << "  \\ " << "   / " << "  \\ " << "   / " << "  \\ " << "   / "
             << "  \\ " << "   / " << "  \\ " << "   / " << "  \\ " << "   / " << "  \\ " << "   / " << "  \\ " << endl;
        cout << "\t\t   " << letter[0] << "   ---" << "  " << letter[1] << "  ---" << "   " << letter[2] << "   ---"
             << "  " << letter[3] << "   ---" << "  " << letter[4] << "   ---" << "  " << letter[5] << "   ---" << "  "
             << letter[6] << "   ---" << "  " << letter[7] << "   ---" << "  " << letter[8] << endl;
        cout << "\t\t \\   " << "/ " << "   \\   " << "/ " << "   \\   " << "/ " << "   \\   " << "/ " << "   \\   "
             << "/ " << "   \\   " << "/ " << "   \\   " << "/ " << "   \\   " << "/ " << "   \\   " << "/ " << endl;
        cout << "\t\t  ---" << "    " << "  ---" << "    " << "  ---" << "    " << "  ---" << "    " << "  ---"
             << "    " << "  ---" << "    " << "  ---" << "    " << "  ---" << "    " << "  ---" << "    " << endl;
    ...
    void displayGameInfo(int levelWords) {
        ...
        cout << "Lives: " << tries << "\t\t\t\t" << "Level:" << level << "\t\t\t\t" << "(Press h)Hints:" << hint << endl
             << endl;
        cout << "Score: " << userinfo.getScore() << "\t\t\t\t" << "Press e to exit" << "\t\t\t\t\t" << "Words Formed:"
             << wordCount << endl << endl;
    ...
    void gameIntro() {
        ...
        cout << "\tYou've found the villian's liar but to save the princess you must go through three set of doors!"
             << endl << endl;
        cout << "\tEach door consists of 9 letters and you must generate valid english words of minimum length 3."
             << endl << endl;
...
private:
    ...
    int call() {
        int hint;
        string output;
        string wordPool[10] = {"Efficient", "Learning", "World", "Hello", "Name", "Share", "Complete", "Global",
                               "Comment"};
        char arr[10][10];
    ...
    void updateScore() {
        userinfo.setScore(userinfo.getScore() + difficultyLevel);
    }
